...
export default function DarkLightMode() {
    ...
    return (
        <button id="theme-toggle" type="button" className="ml-6 text-gray-800 bg-white border border-gray-100 dark:border-gray-800 dark:bg-transparent dark:text-gray-500 focus:outline-none focus:ring-0 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5" onClick={() => {onClickChangeColorMode()}}>
