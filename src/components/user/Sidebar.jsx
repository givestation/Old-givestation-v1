...
export default function Sidebar() {
  ...
  return (
      <nav className="sidebar bg-sidebar md:left-0 md:block md:top-28 md:bottom-0 md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-gray-900 flex flex-wrap items-center justify-between relative md:w-80 z-10 transition-all duration-300">
