...
import DarkLightModeUser from "../user/DarkLightModeUser";

export default function HeaderUser() {
  const [active, setActive] = useState("Optimism");
  ...
  return (
    <div className="pl-6 pr-16 header header-user w-full dark:bg-slate-900">
      <section className="relative overflow-hidden">
        <div className="bg-tarnsparent">
            ...
            <div className="flex justify-between items-center w-full">
              <div className="w-2/12">
                <NavLink className="flex items-center whitespace-nowrap" to="/">
                  ...
                  <h4 className=" ml-1 font-medium text-3xl title text-gray-100 dark:text-gray-100 tracking-widest">
                    GiveStation
                  </h4>
                </NavLink>
              </div>
                    ...
                    <NavLink
                      className={(props) => {
                        return props.isActive
                          ...
                          : "text-gray-100 font-normal dark:text-gray-100 tracking-widest";
                      }}
                      to="/give-dad"
                    >
                      GiveDAO
                  ...
                  <li className="">
                    <NavLink
                      className={(props) => {
                        return props.isActive
                          ? "font-normal dark:text-gray-100 tracking-widest"
                          : "text-gray-100 tracking-widest font-normal dark:text-gray-100";
                      }}
                      to="/campaigns"
                    >
                      How it works
              ...
              <div className="xl:w-5/12 lg:w-6/12 w-6/12">
                <div className="hidden xl:flex items-center justify-end">
                  <button
                    className="py-2 flex justify-center items-center px-6 text-md leading-5 text-slate-900 bg-gradient-secondary font-bold rounded-full dark:text-gray-100 whitespace-nowrap"
                    onClick={() => {
                      setPopup(!popup);
                    }}
                  >
                    <img
                      ...
                      alt="op"
                      className="opimg mr-2"
                    />
                    {active}
                  </button>
                  <button
                    className="ml-6 py-2 px-6 text-md leading-5 text-slate-900 bg-gradient-secondary font-bold rounded-full dark:text-gray-100 whitespace-nowrap"
                    onClick={() => {
          ...
          {menu ? (
            <>
              <div
                className="navbar-menu fixed top-0 left-0 z-50 w-full h-full bg-opacity-50 shadow-lg"
                onClick={() => {
                  setMenu(!menu);
                }}
              >
                  ...
                  <nav className="relative h-full overflow-y-auto">
                    <div className="flex flex-col h-full bg-gray-800">
                      <div className="flex items-center justify-between py-6 px-6 bg-gray-900">
                        ...
                        >
                          <img
                            ...
                            alt="logo"
                          />
                          <h4 className=" ml-1 font-medium text-xl title text-white tracking-widest">
                            GiveStation
                          </h4>
                        </NavLink>
                        <button
                      ...
                      <div className="bg-gray-800">
                        <ul
                          className="md:flex-col md:min-w-full flex flex-col list-none pb-8"
                          onClick={() => {
                            setMenu(!menu);
                          }}
                        >
                          <li className="items-center hover:bg-primary">
                            <NavLink
                              ...
                              className={(props) => {
                                return props.isActive
                                  ? "capitalize py-2.5 px-6 block text-slate-800 whitespace-nowrap text-md border-b border-gray-700 bg-primary"
                                  : "capitalize py-2.5 px-6 block text-white  hover:text-slate-800 whitespace-nowrap text-md border-b border-gray-700";
                              }}
                            >
                              Create Campaign
                            </NavLink>
                        ...
                        <div className="flex flex-wrap px-8">
                          <div className="w-full flex justify-center">
                            <button
                              ...
                              className="py-2 px-4 text-sm leading-5 text-white bg-gradient-secondary font-bold rounded-full"
                              to="/"
                            >
                              {connected ? "Connected" : "Connect Wallet"}
                            </button>
              ...
              <div className="px-6">
                <div className="popup-body px-5 py-5 rounded-xl">
                  <div className="flex justify-between items-start">
                    <h5
                      className="text-white pop-title font-bold text-lg cursor-pointer"
                      onClick={() => {
                        setConnected(true);
                        setConnectPopup(!connectPopup);
                      }}
                ...
                <div className="popup-content pt-2 px-5">
                  ...
                  <div className="flex justify-between items-start py-2 md:py-4">
                    ...
                    >
                      GiveWallet<span className="text-xs">(Coming Soon)</span>{" "}
                    </h5>
                    <img
                  ...
                  <div className="connectbtn mt-6 text-center">
                    <button className="block bg-light-blue text-white px-10 py-2 rounded-xl w-9/12 mx-auto text-lg">
                      Connect
                    </button>
                    <p className="my-3 text-xs text-white">
                      ...
                      <a
                        href="/"
                        className="text-blue-500 ml-1.5 underline underline-offset-2"
                      >
          ...
          <section className="popup fixed w-full top-0 left-0 z-50 min-h-screen flex items-center justify-center">
            <div className="main-popup">
              ...
              <div className="px-6">
                <div className="popup-body px-5 py-5 rounded-xl">
                  <div className="flex justify-between items-start">
                    <h5 className="text-white pop-title font-bold text-lg">
                      {active}
                    </h5>
